...
def contact(request):
   ...
   if request.method == 'POST':
       ...
       message = render_to_string('bank/secure.html', ctx)
...
def transaction_history( request):
    ...
    context = {'transfer':transfer, 'withdraw':withdraw}
...
def withdraw( request):
    ...
    withdraw = user.withdraw_set.all()
...
@login_required (login_url = "login")
def pin(request):
    return render (request, "bank/pin.html")